	...
	public static void main1(String[] args) {
		...
		if (tokens != null && tokens.length > 1) {
			...
			for (int x = 1; x < tokens.length; x++) {
				int value = new Integer(tokens[x]).intValue()
						- new Integer(tokens[x - 1]).intValue();
